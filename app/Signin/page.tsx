        ...
        <div className="flex flex-col space-y-1 bg-white w-4/5 h-3/5 lg:w-3/5 lg:h-3/5 p-3 justify-center items-center rounded-lg space-x-5">
         ...
         <div className="flex justify-center items-center space-x-2">
           ...
           <div className="flex flex-1 flex-col  space-y-2">
                ...
                :
                <button onClick={SigninUser} className=" flex space-x-1 rounded-sm text-sm   text-white justify-center items-center bg-gray-800 px-3 py-1">
                <PowerIcon   className="h-4 w-4"/>
                <div>LOGIN</div>
                </button>}

                <div className='flex flex-1 mt-6'>
                                                                <p className=' text-sm mt-2'>Don{"'"}t have an account? Signup now.</p>
                                                        </div>
